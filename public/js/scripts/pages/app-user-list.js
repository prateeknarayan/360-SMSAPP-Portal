...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: 'http://local.laraveladmin/su/data/users-list', // JSON file to add data
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              ...
              Admin: feather.icons['settings'].toSvg({ class: 'font-medium-3 text-warning me-50' }),
              Manager: feather.icons['database'].toSvg({ class: 'font-medium-3 text-success me-50' }),
              Executive: feather.icons['edit-2'].toSvg({ class: 'font-medium-3 text-info me-50' })
            };
