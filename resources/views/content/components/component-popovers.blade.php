    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Popover Positionshghg</h4>
        </div>
        <div class="card-body">
          ...
          <div class="demo-inline-spacing">
            <button
              ...
              data-bs-content="<b>cggMacaroon chocolate candy. I love carrot cake gingerbread cake lemon drops. Muffin sugar plum marzipan pie.</b>"
            >
              Popover on top
            </button>
            <button
